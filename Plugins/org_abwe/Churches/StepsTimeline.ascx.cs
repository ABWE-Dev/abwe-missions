    ...
    public partial class StepsTimeline : PersonBlock
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if ( !Page.IsPostBack )
            {
                ...
                {
                    // don't show the block if a PersonId isn't in the URL
                    this.Visible = false;
                }
            } else
            {
        ...
        public void ShowDetail( int personId )
        {
            ...
            hfPersonAliases.Value = "(" + String.Join(" or ", this.Person.Aliases.Select(a => $"PersonAliasId eq {a.Id}")) + ")";
        ...
        protected void rptStepTypeLegend_ItemDataBound( object sender, System.Web.UI.WebControls.RepeaterItemEventArgs e )
        {
            ...
            if ( stepTypeCache != null )
            {
                ...
                {
                    style = "background-color:" + stepTypeCache.HighlightColor + "; color: white;";
                }
