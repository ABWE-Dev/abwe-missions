<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChurchRelationships.ascx.cs" Inherits="RockWeb.Plugins.org_abwe.RockMissions.ChurchRelationships" %>
        ...
        <section class="panel panel-persondetails">
            ...
            <div class="panel-heading rollover-container clearfix">
                <h3 class="panel-title pull-left">
                    ...
                    <asp:Literal ID="lGroupName" runat="server" Text="Contacts"></asp:Literal></h3>
